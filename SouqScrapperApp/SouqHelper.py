    ...
    def __init__(self):
        ...
        self.urls_dict = [
            {self.collection_key: "Men's T-Shirts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's T-Shirts, Round Neck"},
            ...
            {self.collection_key: "Men's T-Shirts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's T-Shirts, V Neck "},
            ...
            {self.collection_key: "Men's T-Shirts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's T-Shirts, Shirt Neck "},
            ...
            {self.collection_key: "Men's Vests",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Vests "},
            ...
            {self.collection_key: "Men's Shorts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Shorts, Bermuda Shorts "},
            ...
            {self.collection_key: "Men's Shorts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Shorts, Drawstring Shorts "},
            ...
            {self.collection_key: "Men's Shorts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Shorts, Cargo Shorts "},
            ...
            {self.collection_key: "Men's Jeans",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Jeans, Slim Fit "},
            ...
            {self.collection_key: "Men's Jeans",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Jeans, Straight "},
            ...
            {self.collection_key: "Men's Jeans",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Jeans, Skinny "},

            {self.collection_key: "Men's Jeans",
             self.sub_collection_key: 'Ripped',
             self.isFashion_key: False,
             self.url_key: 'https://uae.souq.com/ae-en/jeans/pants-477/men/ripped/a-t-6356-6314/s/',
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Jeans, Ripped "},
            ...
            {self.collection_key: "Men's Coats, Jackets & Hoodies",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Coats, Jackets & Hoodies, Zip Up Hoodie "},
            ...
            {self.collection_key: "Men's Coats, Jackets & Hoodies",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Coats, Jackets & Hoodies, Puffer Jacket "},
            ...
            {self.collection_key: "Men's Coats, Jackets & Hoodies",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Coats, Jackets & Hoodies, Bomber Jacket "},
            ...
            {self.collection_key: "Men's Shirts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Shirts, Full Sleeve "},
            ...
            {self.collection_key: "Men's Shirts",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Shirts, Short Sleeve "},
            ...
            {self.collection_key: "Men's Suits",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Suits, Tuxedo "},
            ...
            {self.collection_key: "Men's Suits",
             ...
             self.tags_key: "Men's, Souq, Middle East, Men's Clothing, Men's Suits, Business Suit "},
            ...
            {self.collection_key: "Men's Underwear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Underwear, Boxers"
             },
            {self.collection_key: "Men's Underwear",
             self.sub_collection_key: 'Briefs',
             self.isFashion_key: False,
             self.url_key: 'https://uae.souq.com/ae-en/underwear/underwear-489/men/briefs/a-t-6356-6337/s/',
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Underwear, Briefs"},
            ...
            {self.collection_key: "Men's Sportswear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Sportswear, Sports Tops"},
            ...
            {self.collection_key: "Men's Sportswear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Sportswear, Sports Shorts"},
            ...
            {self.collection_key: "Men's Sportswear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Sportswear, Sports Pants"},
            ...
            {self.collection_key: "Men's Sportswear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Sportswear, Sports Jackets"},
            ...
            {self.collection_key: "Men's Sportswear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Sportswear, Sports Vests"},
            ...
            {self.collection_key: "Men's Swimwear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Swimwear, Swim Shorts"},
            ...
            {self.collection_key: "Men's Swimwear",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Swimwear, Swim Trunks"},
            ...
            {self.collection_key: "Men's Hats",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Hats"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Bifold Wallets"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Card & ID Cases"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Trifold Wallets"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Zip Around Wallets"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Flap Wallets"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Clip Wallet"},
            ...
            {self.collection_key: "Men's Wallets",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Wallets, Travel & Document Holders"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Square"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Aviator"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Rectangle"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Oval"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Wayfarer"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Wrap Around"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Round"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Rimless"},
            ...
            {self.collection_key: "Men's Sunglasses",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Sunglasses, Half Frame"},
            ...
            {self.collection_key: 'Men`s Flip-Flops',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Flip-Flops"},
            ...
            {self.collection_key: 'Men`s Trainers ',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Trainers, Casual Trainers"},
            ...
            {self.collection_key: 'Men`s Trainers ',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Trainers, Athletic Trainers"},
            ...
            {self.collection_key: 'Men`s Formal Shoes ',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Formal Shoes, Loafers & Moccasins"},
            ...
            {self.collection_key: 'Oxfords & Wingtips ',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Formal Shoes, Oxfords & Wingtips"},
            ...
            {self.collection_key: 'Oxfords & Wingtips ',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Formal Shoes, Slip-Ons"},
            ...
            {self.collection_key: 'Men`s Boots ',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Shoes, Men's Boots"},

            {self.collection_key: 'Men`s Holdalls',
             self.sub_collection_key: None,
             self.isFashion_key: False,
             self.url_key: 'https://uae.souq.com/ae-en/duffle-bag/duffle-bags-559/men/a-t-6356/s/',
             self.tags_key:"Men's, Souq, Middle East, Men's Bags, Men's Holdalls"},
            ...
            {self.collection_key: 'Men`s Backpacks',
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Bags, Men's Travel Cases"},
            ...
            {self.collection_key: "Men's Coats, Jackets & Hoodies",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Clothing, Men's Coats, Jackets & Hoodies, Zip Up Jacket"},
            ...
            {self.collection_key: "Men's Cufflinks",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Accessories, Men's Belts"},
            ...
            {self.collection_key: "Men's Travel Cases",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Bags, Men's Backpacks"},
            ...
            {self.collection_key: "Men's Briefcases & Work Bags",
             ...
             self.tags_key:"Men's, Souq, Middle East, Men's Bags, Men's Briefcases & Work Bags"},
            ...
            {self.collection_key: "Women's Tops",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Clothing, Women's Tops, Hoodies & Sweatshirts"},
            ...
            {self.collection_key: "Women's Jeans",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Clothing, Women's Jeans, Slim Fit"},
            ...
            {self.collection_key: "Women's Watches",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Accessories, Women's Watches"},
            ...
            {self.collection_key: "Women's Boots",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Shoes, Women's Boots, Lace Up Boots"},
            ...
            {self.collection_key: "Women's Wedges",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Shoes, Women's Wedges"},
            ...
            {self.collection_key: "Women's Backpacks",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Bags, Women's Backpacks"},
            ...
            {self.collection_key: "Women's Tote Bags",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Bags, Women's Tote Bags"},
            ...
            {self.collection_key: "Women's Crossbody Bags",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Bags, Women's Crossbody Bags"},
            ...
            {self.collection_key: "Women's Clutches",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Bags, Women's Clutches"},
            ...
            {self.collection_key: "Women's Luggage & Suitcases",
             ...
             self.tags_key:"Middle East, Souq.com, Women's, Women's Bags, Women's Luggage & Suitcases"},
        ]